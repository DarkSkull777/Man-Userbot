...
@man_cmd(pattern="toxic$")
async def _(event):
    e = await edit_or_reply(event, "ANJING")
    await e.edit("MEMEK")
    await e.edit("BANGSAT")
    await e.edit("NGENTOD")
    await e.edit("JEMBUT")
    await e.edit("KONTOL")
    await e.edit("TAI")
    await e.edit("BABI")
    ...
    await e.edit("JANCOK")
    await e.edit("ASU")
    await e.edit("CANDA DEK🥴")


@man_cmd(pattern="dymles$")
async def _(event):
    e = await edit_or_reply(event, "S")
    await e.edit("Sh")
    await e.edit("Shu")
    await e.edit("Shut")
    await e.edit("Shut U")
    await e.edit("Shut Up")
    await e.edit("Shut Up B")
    await e.edit("Shut Up Bi")
    await e.edit("Shut Up Bit")
    await e.edit("Shut Up Bitc")
    await e.edit("Shut Up Bitch")
    await e.edit("Shut Up Bitch!")
    await e.edit("Shut Up Bitch! D")
    await e.edit("Shut Up Bitch! Dy")
    await e.edit("Shut Up Bitch! Dym")
    await e.edit("Shut Up Bitch! Dyml")
    await e.edit("Shut Up Bitch! Dymle")
    await e.edit("Shut Up Bitch! Dymles")
    await e.edit("Shut Up Bitch! Dymles W")
    await e.edit("Shut Up Bitch! Dymles Wa")
    await e.edit("Shut Up Bitch! Dymles Was")
    await e.edit("Shut Up Bitch! Dymles Was H")
    await e.edit("Shut Up Bitch! Dymles Was He")
    await e.edit("Shut Up Bitch! Dymles Was Her")
    await e.edit("Shut Up Bitch! Dymles Was Here")
    await e.edit("Shut Up Bitch! Dymles Was Here!!!")
